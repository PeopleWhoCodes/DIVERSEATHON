...
const style = {
    extraLinksPara: `cursor-pointer w-max`,
...
const Footer = () => {
    return (
        <div className='py-10 pb-5 flex flex-col items-center text-white gap-y-4 screen4:gap-y-4 screen5:gap-y-2 screen5:pt-7'>
            {/* TOP */}
            <div className='flex justify-evenly items-start mb-8'>
                {/* Left Links */}
                <div className='left-links flex w-full items-center justify-between px-32 screen6:w-[90%] screen6:px-0'>
                    <div className='left flex flex-col gap-y-2'>
                        <div className='heading'>
                            <h1 className={style.heading}>Quick Links</h1>
                        </div>
                        <div className='socialLink flex flex-col gap-x-3'>
                            <HashLink
                                to='/events'
                                className={style.extraLinksPara}
                            >
                                Events
                            </HashLink>
                            <HashLink
                ...
                <div className='left-links flex w-full items-center justify-between px-32 screen6:w-[90%] screen6:px-0'>
                    <div className='left flex flex-col gap-y-2'>
                        <div className='heading'>
                            <h1 className={style.heading}>Other Links</h1>
                        </div>
                        <div className='socialLink flex flex-col gap-x-3'>
                            <HashLink
                                to='/team'
                            ...
                            <HashLink to='/' className={style.extraLinksPara}>
                                Volunteers
                            </HashLink>
                            <HashLink to='/' className={style.extraLinksPara}>
                                Blogs
            ...
            {/* Reserved */}
            <div className='reserved flex flex-col items-center gap-y-1'>
                <h1 className='text-lg font-medium text-center screen5:text-xl'>
